...
public class CustomAdapterReceipts extends BaseAdapter {
    ...
    public CustomAdapterReceipts(Context context, JSONArray jsonArray) {
        super();
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        try {
            emailView.setText(currentObject.getString("Customer_Email"));
